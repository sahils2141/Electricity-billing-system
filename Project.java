...
public class Project extends JFrame implements ActionListener {
	...
	Project(String atype,String meter){
		...
		master.setFont(new Font("Elephant",Font.PLAIN,25));
		master.setForeground(Color.RED);

		setJMenuBar(mb);
		
		JMenuItem newcustomer = new JMenuItem("New Customer");
		newcustomer.setFont(new Font("time new roman",Font.BOLD,18));
		...
		customerdetails.setFont(new Font("time new roman",Font.BOLD,18));
		...
		depositdetails.setFont(new Font("time new roman",Font.BOLD,18));
		...
		calculatebill.setFont(new Font("time new roman",Font.BOLD,18));
		...
		info.setFont(new Font("Elephant",Font.PLAIN,25));
		
		
		JMenuItem updateinformation = new JMenuItem("Update Information");
		updateinformation.setFont(new Font("time new roman",Font.BOLD,18));
		updateinformation.setBackground(Color.CYAN);
		...
		viewinformation.setFont(new Font("time new roman",Font.BOLD,18));
		viewinformation.setBackground(Color.CYAN);
		...
		user.setFont(new Font("Elephant",Font.PLAIN,25));
	
		
		JMenuItem paybill = new JMenuItem("Pay Bill");
		paybill.setFont(new Font("time new roman",Font.BOLD,18));
		...
		billdetails.setFont(new Font("time new roman",Font.BOLD,18));
		billdetails.setBackground(Color.CYAN);
		...
		report.setFont(new Font("Elephant",Font.PLAIN,25));
		
		
		JMenuItem generatebill = new JMenuItem("Generate Bill");
		generatebill.setFont(new Font("time new roman",Font.BOLD,18));
		generatebill.setBackground(Color.CYAN);
		...
		utility.setFont(new Font("Elephant",Font.PLAIN,25));
		
		JMenuItem notepad = new JMenuItem("Notepad");
		notepad.setFont(new Font("time new roman",Font.BOLD,18));
		...
		calculator.setFont(new Font("time new roman",Font.BOLD,18));
		...
		mexit.setFont(new Font("Elephant",Font.PLAIN,25));
		
		JMenuItem exit = new JMenuItem("Exit");
		exit.setFont(new Font("time new roman",Font.BOLD,18));
